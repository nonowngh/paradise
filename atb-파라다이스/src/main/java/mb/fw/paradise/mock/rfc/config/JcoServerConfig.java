package mb.fw.paradise.mock.rfc.config;
...
import mb.fw.paradise.mock.rfc.handler.MockCallHandlerFactory;
import mb.fw.paradise.mock.rfc.provider.InMemoryServerProvider;
import mb.fw.paradise.mock.rfc.repository.MockRepository;

@Configuration
@ConditionalOnAdaptorType(AdaptorType.RFC_SIMUL)
