...
public enum PatternType {
	...
	// RFC2DB(배치)
	RFCBATCH_DB("RB2D", TargetContextPathConstants.RCV_DB_PROCESS),
	// RFC2DB(서버)
	RFCSERVER_DB("RS2D", TargetContextPathConstants.RCV_DB_PROCESS_SYNC),
	// RFC2API(서버)
	RFCSERVER_API("RS2A", TargetContextPathConstants.RCV_API_CALL_SYNC),
	// DB2DB
